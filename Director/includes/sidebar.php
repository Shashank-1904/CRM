            ...
            <ul class="sidebar-links" id="simple-bar">
              ...
              <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title"
                  ...
                  <svg class="fill-icon">
                    ...
                    <svg class="icon-bed-pulse"><use style="fill:white" xlink:href="../assets/svg/icons.svg#icon-bed-pulse"></use></svg>
              ...
              <li class="sidebar-main-title">
                <div>
                  <h6 class="lan-12">Suggestion Box</h6>
                </div>
              </li>
              <!-------------------------------------Title-End----------------------------------------------------------->  
              <!-------------------------------------Bar_List----------------------------------------------------------->
